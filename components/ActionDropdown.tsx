...
import { FileDetails, ShareInput } from "./ActionsModalComponent"
...
const ActionDropdown = ({file} : CardProps) => {
    ...
    // Handler for input changes in ShareInput
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        // This will be called from ShareInput when user types
        // You can implement the logic based on your needs
    }
    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
            <DropdownMenuTrigger className="shad-no-focus">
                <Image src="/assets/icons/dots.svg" alt="dots"
                    width={34} height={34} />
            </DropdownMenuTrigger>
            <DropdownMenuContent>
                ...
                {actionsDropdownItems.map(actionItem => (
                    <DropdownMenuItem key={actionItem.value} className="shad-dorpdown-item" onClick={() => {
