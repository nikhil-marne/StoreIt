...
const Sidebar = ({fullName, email, avatar} : sidebarProps) => {
  ...
  return (
    <aside className="sidebar">
        <Link href="/">
            <Image src="/assets/icons/logofullbrand.svg" alt="logo" width={160} height={50} className="hidden h-auto lg:block" />
        ...
        <div className="sidebar-user-info">
            <Image src={avatar} alt="Avatar" width={44} height={44} className="sibebar-user-avater" />
